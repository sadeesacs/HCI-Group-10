...
// Image path constants (point to frontend public assets)
const chair1 = "/assets/products/chair-1.jpg";
const table1 = "/assets/products/table-1.jpg";
const bookshelf1 = "/assets/products/bookshelf-1.jpg";
const lamp1 = "/assets/products/lamp-1.jpg";
const bedside1 = "/assets/products/bedside-1.jpg";
const armchair1 = "/assets/products/armchair-1.jpg";
const console1 = "/assets/products/console-1.jpg";
const pendant1 = "/assets/products/pendant-1.jpg";
const diningTableNew = "/assets/products/dining-table-new.jpg";

export const baseProducts: (ProductSeed & { id: string })[] = [
  {
    id: "1",
...
export const baseProductExtras: ProductExtras = {
  "1": {
